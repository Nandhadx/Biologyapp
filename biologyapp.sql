...
--
-- Host: localhost
-- Generation Time: Oct 18, 2023 at 04:51 PM
...
(31, 'Social Science', 'hello students', '2023-10-18 06:44:01', '2023-10-18 06:44:01');
...
INSERT INTO `courses` (`CourseID`, `CourseName`, `Description`, `InstructorID`, `StartDate`, `EndDate`, `Price`, `Level`, `Category`, `IsActive`) VALUES
(3, 'nandha', 'Nandha', NULL, '2023-10-06', '2023-10-22', '100.00', 'Beginner', '31', 0);
...
INSERT INTO `instructors` (`InstructorID`, `FirstName`, `LastName`, `Email`, `Biography`, `ProfileImageURL`, `JoinDate`, `IsActive`) VALUES
(7, 'nandha', 'gopal', 'nandhagopa9943@gmail.com', 'hello', NULL, '2023-10-18', NULL);
...
CREATE TABLE `resources` (
  ...
  `CourseID` int(11) DEFAULT NULL,
  `ResourceType` enum('Video','PDF') DEFAULT NULL,
...
INSERT INTO `resources` (`ResourceID`, `CourseID`, `ResourceType`, `ResourceFile`, `FileName`, `UploadDate`) VALUES
(4, 3, 'Video', 'SAT LIGHTS AND POWER 9001 CA.pdf', 'pdf file example', '2023-10-18 13:14:40'),
(5, 3, 'PDF', 'TrustSeal_certificate.pdf', 'pdf file example', '2023-10-18 13:18:11'),
(6, 3, 'Video', '3.4.3 Website.pdf', 'pdf file example', '2023-10-18 13:57:42'),
(7, 3, 'Video', 'file_example_MP4_480_1_5MG.mp4', 'video file example', '2023-10-18 14:14:25'),
(8, 3, 'Video', 'file_example_MP4_480_1_5MG.mp4', 'video file example', '2023-10-18 14:14:47'),
(9, 3, 'Video', 'file_example_MP4_480_1_5MG.mp4', 'video file example', '2023-10-18 14:22:39'),
(10, 3, 'Video', 'TrustSeal_certificate.pdf', 'pdf file example', '2023-10-18 14:25:30'),
(11, 3, 'Video', 'file_example_MP4_480_1_5MG.mp4', 'pdf file example', '2023-10-18 14:25:43'),
(12, 3, 'PDF', 'Projects_Credentials.pdf', 'pdf file example', '2023-10-18 14:27:57');
