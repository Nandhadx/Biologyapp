                        ...
                        <div class="card-body pt-5">
                            ...
                            <div class="d-flex align-items-sm-center mb-9">
                                ...
                                <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                    ...
                                    <div class="flex-grow-1 me-2">
                                        <a href="#" class="text-gray-800 text-hover-primary fs-4 fw-boldest">Piper
                                            Aerostar</a>
                            ...
                            <div class="d-flex align-items-sm-center mb-9">
                                ...
                                <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                    <!--begin::Block-->
                                    <div class="flex-grow-1 me-2">
                                        <a href="#" class="text-gray-800 text-hover-primary fs-4 fw-boldest">Cirrus
                                            SR22</a>
                            ...
                            <div class="d-flex align-items-sm-center mb-9">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <span class="symbol-label">
                                        <img src="assets/media/svg/misc/puzzle.svg" class="h-50 align-self-center"
                                            alt="" />
                                    </span>
                                </div>
                                <!--end::Symbol-->
                                ...
                                <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                    ...
                                    <div class="flex-grow-1 me-2">
                                        <a href="#"
                                            class="text-gray-800 text-hover-primary fs-4 fw-boldest">Beachcraft Baron</a>
                            ...
                            <div class="d-flex align-items-sm-center mb-9">
                                ...
                                <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                    <!--begin::Block-->
                                    <div class="flex-grow-1 me-2">
                                        <a href="#" class="text-gray-800 text-hover-primary fs-4 fw-boldest">Active
                                            Customers</a>
                                        <span class="text-muted fw-bold d-block pt-1">Mark, Rowling, Esther</span>
                                    </div>
                                    <!--end::Block-->
                            ...
                            <div class="d-flex align-items-sm-center mb-0">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <span class="symbol-label">
                                        <img src="assets/media/svg/misc/infography.svg" class="h-50 align-self-center"
                                            alt="" />
                                    </span>
                                </div>
                                <!--end::Symbol-->
                                ...
                                <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                    <!--begin::Block-->
                                    <div class="flex-grow-1 me-2">
                                        <a href="#" class="text-gray-800 text-hover-primary fs-4 fw-boldest">Cessna
                                            SF150</a>
                                            ...
                                            <td class="p-0">
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-2">
                                                        <span class="symbol-label">
                                                            <img alt="" class="w-25px"
                                                                src="assets/media/svg/misc/recycling.svg" />
                                                        </span>
                                                    </div>
                                                    <div class="ps-3">
                                                        <a href="#"
                                                            ...
                                                            Clarc</a>
                                                        <span class="text-gray-400 fw-bold d-block">PHP, SQLite, Artisan
                                                            CLI</span>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="p-0">
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-2">
                                                        <span class="symbol-label">
                                                            <img alt="" class="w-25px"
                                                                src="assets/media/svg/misc/eolic-energy.svg" />
                                                        </span>
                                                    </div>
                                                    <div class="ps-3">
                                                        <a href="#"
                    ...
                    <div class="card mb-5 mb-xxl-8 card-xxl-stretch">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <!--end::Heading-->
                                <!--begin::Title-->
                                <a href="#" class="text-dark fw-bolder fs-2 text-hover-primary">Dis’ - Multiple
                                    Email Generator Dashboard Admin</a>
                                <!--end::Title-->
                                <!--begin::Desc-->
                                <p class="pt-5 fw-bold text-gray-600 fs-5">Outlines keep you honest. If stop indulging in
                                    poorly thought-out metaphors driving and keep structure many emails</p>
                                <!--end::Desc-->
                            </div>
                            <!--end::Wrapper-->
                            <!--begin::Users-->
                            <div class="mt-13">
                                <!--begin::User-->
                                <a href="#" class="symbol symbol-40px me-2" data-bs-toggle="tooltip"
                                    title="Ricky Hunt">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="d-flex flex-stack pr-2 mb-5">
                                    ...
                                    <div class="symbol symbol-50px">
                                        <div class="symbol-label">
                                            <img src="assets/media/svg/misc/puzzle.svg" class="h-30px align-self-center"
                                                alt="" />
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
                                ...
                                <!--end::Heading-->
                                <!--begin::Title-->
                                <a href="#" class="text-dark fw-bolder fs-2 text-hover-primary">Jet - ReactJS Admin
                                    Dashboard Template</a>
                                <!--end::Title-->
                                <!--begin::Desc-->
                                <p class="pt-5 fw-bold text-gray-600 fs-5">Outlines keep you honest. If stop and indulging
                                    in poorly thought-out metaphors driving and keep structure many emails indulging in poor
                                    conmne thought-out metaphors driving and keep a good structure many emails</p>
                                <!--end::Desc-->
                            </div>
                            <!--end::Wrapper-->
                            <!--begin::Users-->
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="d-flex flex-stack pr-2 mb-5">
                                    ...
                                    <div class="symbol symbol-50px">
                                        <div class="symbol-label">
                                            <img src="assets/media/svg/misc/recycling.svg"
                                                class="h-30px align-self-center" alt="" />
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
                                ...
                                <!--end::Heading-->
                                <!--begin::Title-->
                                <a href="#" class="text-dark fw-bolder fs-2 text-hover-primary">KT.com - Hight
                                    Quality Themes by Maret Leaders</a>
                                <!--end::Title-->
                                <!--begin::Desc-->
                                <p class="pt-5 fw-bold text-gray-600 fs-5">Outlines keep you honest. If stop indulging in
                                    poorly thought-out metaphors driving and keep structure many good emails indulging in
