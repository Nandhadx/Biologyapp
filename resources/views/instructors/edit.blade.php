                ...
                <div class="col-xxl-5">
                    ...
                    <div class="card card-xxl-stretch">
                        ...
                        <div class="card-body d-flex flex-column justify-content-between h-100">
                            <form method="POST" action="{{ route('instructors.edit', $instructor->InstructorID) }}">
                                @csrf
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary mt-2"><i
                                            class="bi bi-plus-circle-fill"></i>{{ isset($instructor) ? 'Update' : 'Create' }}
                                    </button>
                                    <a href="{{ route('instructors.index') }}" class="btn btn-danger mt-2">
