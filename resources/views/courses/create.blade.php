                                ...
                                <div class="row g-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-solid @error('CourseName') is-invalid @enderror"
                                            id="CourseName" name="CourseName" placeholder="Enter Course Name" value="{{ old('CourseName') }}">
                                        @error('CourseName')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control form-control-solid @error('Description') is-invalid @enderror"
                                            id="Description" name="Description" rows="4" placeholder="Enter Course Description">{{ old('Description') }}</textarea>
                                        @error('Description')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group m-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" class="form-check-input @error('IsActive') is-invalid @enderror"
                                               name="IsActive" id="activeYes" value="1" @if(old('IsActive') == 1) checked @endif>
                                        <label class="form-check-label" for="activeYes">Yes</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" class="form-check-input @error('IsActive') is-invalid @enderror"
                                               name="IsActive" id="activeNo" value="0" @if(old('IsActive') == 0) checked @endif>
