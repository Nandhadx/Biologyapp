                            ...
                            <div data-kt-menu-trigger="click" data-kt-menu-placement="right-start"
                                ...
                                <div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
                                    ...
                                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                        data-kt-menu-placement="right-start" data-kt-menu-flip="bottom"
                                            ...
                                            <div class="d-flex flex-column px-9">
                                                ...
                                                <div class="text-center mb-5 px-4">
                                                    <img class="mw-100 mh-175px" alt=""
                                                        src="assets/media/illustrations/verification.png" />
                                                </div>
                                                <!--end::Illustration-->
                                            </div>
                                            <!--end::Wrapper-->
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold py-4 fs-6 w-275px"
                                    ...
                                    <div class="menu-item px-5" data-kt-menu-trigger="hover"
                                        ...
                                        <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                            ...
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="{{ route('login') }}" class="menu-link px-5">Payments</a>
                                            </div>
                                            <div class="menu-item px-3">
                                                <a href="apps/subscriptions/view.html"
        ...
        <div class="card shadow-none w-100">
            ...
            <div class="card-body" id="kt_explore_body">
                ...
                <div id="kt_explore_scroll" class="scroll-y me-n5 pe-5" data-kt-scroll="true"
                    ...
                    <!--end::Licenses-->
                    <!--begin::Link-->
                    <a href="https://keenthemes.com/products/jet-html-pro"
            ...
            <div class="card-footer py-5 text-center" id="kt_explore_footer">
                <a href="https://keenthemes.com/products/jet-html-free"
